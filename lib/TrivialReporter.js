...
jasmine.TrivialReporter.prototype.reportFailure = function(result, specDiv) {
  ...
  var showDiff = details.type == "diff";
  var messageHtml = showDiff ? this.formatToEqualResult(result) : result.message;
...
jasmine.TrivialReporter.prototype.formatToEqualResult = function(result) {
  var message = this.createDom("div", {},
      "Expected ",
      this.createDom("span", {className: "actual result"}, jasmine.pp(result.actual)),
      " ",
      result.matcherName,
      " ",
      this.createDom("span", {className: "expected result"}, jasmine.pp(result.expected))
     );
